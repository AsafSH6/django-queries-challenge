...
from django_advanced_queries.covid_19.managers import PatientManager, \
    DepartmentManager, HospitalManager, HospitalWorkerManager, \
    MedicalExaminationsManager, PersonManager
